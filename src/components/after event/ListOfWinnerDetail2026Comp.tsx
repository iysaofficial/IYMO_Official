    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYMO 2026</h1>
            </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>List of Winner Online - Elementary</h2>
                        <br />
                        <Link href="https://drive.google.com/file/d/1l6hl6YqU3yj9hpr32dNAgDXTm-TaJXWI/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                <div className="serviceBox">
                    <div className="icon">
                    ...
                    <div className="content">
                        <h2>List of Winner Online - JHS</h2>
                        <br />
                        <Link href="https://drive.google.com/file/d/1-zZcdn4wwoUqZ86fA97DnrIGa2odTT_N/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/1jqq3vLSQtkHXFefxrhxgr60hNa4v6R0q/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                <div className="serviceBox">
                    <div className="icon">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/1ECCr3zlavIDBQnqQqbUULJs8SRqIxT-j/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <div className="low-press-release-button-container">
                <Link href="#" className="low-press-release-button">Download Press Release</Link>
            </div>
        </section>
        <br />
        </>
