    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYMO 2023</h1>
            </div>
            <div className="low-detail-after-event-container">
                <div className="low-detail-after-event-row">
                    ...
                    <div className="low-detail-after-event-video">
                        <iframe className="mt-5"  width="100%" height="415" src="https://www.youtube.com/embed/NbIE8wAcq8k?si=TJLJu_0SGYimXIX0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                    </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <Link href="https://drive.google.com/file/d/1fjHlncRZczqoLHlD9XOPI8WoWMSoBoOW/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        <h2>Curation</h2>
                        <br />
                        <Link href="https://drive.google.com/drive/folders/13tm0baoRRwDjRo7Ez-BKjUbmeMozNo_x?usp=sharing" target="_blank" className="low-detail-document-button">Download</Link>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <div className="low-press-release-button-container">
                <Link href="https://drive.google.com/file/d/1jkpeD9EN2kWu059MDmriUHgqil_P31xT/view?usp=sharing" className="low-press-release-button">Download Press Release</Link>
            </div>
        </section>
        <br />
        </>
