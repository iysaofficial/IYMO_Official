            ...
            <div className="contact-container">
                <div className="contactInfo">
                    ...
                    <ul className="sci">
                        ...
                        <li><Link href="https://www.instagram.com/iymo.official?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank"><img src="/assets/images/icon/2.png" alt="" /></Link></li>
                ...
                <div className="contactForm">
                    ...
                    <form action="https://formspree.io/f/xgeglpzl" method="POST">
