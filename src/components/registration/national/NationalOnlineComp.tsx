...
const NationalOnlineComp: React.FC = () => {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbyvox0ydVSkG3KEkGY0UpDPNH8giNxEKy9FzP3h-qHu9EQhd0Z4cp7IVUSfnOmjY8eCwQ/exec";
...
const HeaderSection: React.FC = () => (
  <div className="header-section">
    <div className="header-content">
      ...
      <h2 className="event-title">IYMO 2026</h2>
    </div>
  </div>
);
...
const InstructionSection: React.FC = () => (
  <div className="instruction-section">
    <h3 className="instruction-title">
      HELLO IYMO 2026 PARTICIPANTS, Please consider the following information before filling out the registration form :
    </h3>
...
const InformasiUmumSection: React.FC = () => (
  <section className="form-section">
    ...
    <div className="field-grid">
      ...
      <div className="field-group">
        <label className="field-label">IYMO 2026 Competition Information Resources</label>
